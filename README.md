...
## [06 命令模式](src/main/java/com/sherlocky/headfirst/pattern/_06_command)
...
## [07 适配器模式与外观模式](src/main/java/com/sherlocky/headfirst/pattern/_07_adapter)
...
外观模式提供了一个统一（简化）的接口，用来访问子系统中的一群接口。外观定义了一个高层接口，让子系统更容易使用。同时依然将系统完整的功能暴露出来，以供需要的人使用。

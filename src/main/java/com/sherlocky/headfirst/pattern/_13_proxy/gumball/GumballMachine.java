...
public class GumballMachine extends UnicastRemoteObject implements GumballMachineRemote {
    ...
    /**
     * 实现一个构造函数，并抛出 RemoteException，
     * see {@link com.sherlocky.headfirst.pattern._13_proxy.rmidemo.MyRemoteServiceImpl MyRemoteServiceImpl}
     * @param location
    ...
    /**
     * {@link State} 的具体类必须实现可序列化接口，或者改接口必须继承可序列化接口，
     * see {@link HasQuarterState}
     * @return
     */
    @Override
